...
<div class="mb-4">
  <h1 class="h3 fw-bold mb-1">Property & Supply Settings</h1>
        ...
        <form>
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" value="Property and Supply Office" readonly>
            </div>
      ...
      <div class="card-body p-4">
        ...
        <div class="d-flex flex-column gap-3">
          ...
          <div>
            ...
            <div class="fw-bold">Property & Supply Admin</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-6">
    <div class="card rounded-4 border h-100">
      <div class="card-body p-4">
        ...
        <form action="{{ route('pso.settings.appearance') }}" method="POST">
          @csrf
          @method('PUT')
