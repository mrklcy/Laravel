...
<div class="mb-4">
  <h1 class="h3 fw-bold mb-1">RMO Settings</h1>
  <p class="text-muted mb-0">Manage profile and system configuration</p>
</div>
        ...
        <form>
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" value="Records Management Office" readonly>
            </div>

            <div class="col-12">
              <div class="alert alert-warning rounded-4 mb-0 d-flex align-items-center">
                <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24" class="me-2">
      ...
      <div class="card-body p-4">
        ...
        <form>
          <div class="row g-3">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-gold rounded-4">
      ...
      <div class="card-body p-4">
        ...
        <div class="d-flex flex-column gap-3">
          ...
          <div>
            ...
            <div class="fw-bold">RMO Administrator</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-6">
    <div class="card rounded-4 border h-100">
      <div class="card-body p-4">
        ...
        <form action="{{ route('rmo.settings.appearance') }}" method="POST">
          @csrf
          @method('PUT')
