...
<div class="d-flex justify-content-between align-items-start mb-3">
  <div class="d-flex align-items-center gap-3">
    ...
    <div>
      ...
      <div class="text-muted">Update {{ $employee->name }}</div>
    </div>
  </div>
</div>
  ...
  <div class="col-lg-8">
    <div class="card rounded-4 border">
      <div class="card-body p-4">
        <form action="{{ route('admin.users.update', $employee->id) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="mb-4">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                     value="1" {{ old('is_active', $employee->is_active ?? true) ? 'checked' : '' }}>
    ...
    <div class="card rounded-4 border bg-light mt-3">
      <div class="card-body">
        ...
        <ul class="small text-muted mb-0">
          ...
          <li>Deactivating a user prevents them from logging in</li>
        </ul>
      </div>
    </div>
  </div>
