...
<div class="d-flex justify-content-between align-items-start mb-3">
  <div class="d-flex align-items-center gap-3">
    ...
    <div>
      <h1 class="h3 fw-bold mb-1">Edit Program</h1>
      <div class="text-muted">Update {{ $program->title }}</div>
    </div>
  </div>
</div>
...
<div class="row">
        ...
        <form action="{{ route('admin.programs.update', $program) }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control rounded-3 @error('order') is-invalid @enderror" 
                   id="order" name="order" value="{{ old('order', $program->order) }}" min="0" required>
  ...
  <div class="col-lg-4">
    <div class="card rounded-4 border bg-light">
      <div class="card-body">
        <h5 class="fw-bold mb-3">Program Information</h5>
        <div class="small">
          <div class="mb-2">
    ...
    <div class="card rounded-4 border bg-light mt-3">
      <div class="card-body">
        ...
        <ul class="small text-muted mb-0">
          ...
          <li class="mb-2">Deactivating a program hides it from public view</li>
          <li>Adjust display order to reorganize program listings</li>
        </ul>
      </div>
    </div>
  </div>
