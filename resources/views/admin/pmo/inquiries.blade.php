...
<div class="d-flex justify-content-between align-items-start mb-3">
  <div class="d-flex align-items-center gap-3">
    ...
    <div>
      <h1 class="h3 fw-bold mb-1">PMO Inquiries</h1>
      <div class="text-muted">Inquiries directed to the PMO office</div>
    </div>
  </div>
</div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="px-4 text-end">
              <a href="{{ route('pmo.inquiries.show', $inquiry) }}" class="btn btn-sm btn-outline-primary">View</a>
            </td>
          </tr>
          @empty
          <tr>
            <td colspan="6" class="text-center py-5 text-muted">
              No inquiries found for PMO.
            </td>
          </tr>
          @endforelse
        </tbody>
