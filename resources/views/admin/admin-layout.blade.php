...
<head>
  ...
  <style>
    @php
      ...
      $office = \App\Models\Office::where('code', $officeCode)->first();
  ...
  <aside class="sidebar p-3" id="sidebar">
    ...
    <nav class="nav flex-column gap-1">
      ...
      <div class="mt-3 mb-2 px-3">
        <small class="text-muted fw-bold label-text">MODULES</small>
      </div>

      <a class="nav-link" href="{{ route('admin.hrm.dashboard') }}">
        <div style="width:18px;height:18px;border-radius:4px;background:var(--clsu-green);display:flex;align-items:center;justify-content:center;color:white;font-size:10px;font-weight:bold;">H</div>
        <span class="label-text">HRMO Panel</span>
      </a>

      <a class="nav-link" href="{{ route('pmo.dashboard') }}">
        <div style="width:18px;height:18px;border-radius:4px;background:var(--clsu-gold);display:flex;align-items:center;justify-content:center;color:white;font-size:10px;font-weight:bold;">P</div>
        <span class="label-text">PMO Panel</span>
      </a>

      <a class="nav-link" href="{{ route('pso.dashboard') }}">
        <div style="width:18px;height:18px;border-radius:4px;background:var(--clsu-cobra);display:flex;align-items:center;justify-content:center;color:white;font-size:10px;font-weight:bold;">S</div>
        <span class="label-text">PSO Panel</span>
      </a>

      <a class="nav-link" href="{{ route('rmo.dashboard') }}">
        <div style="width:18px;height:18px;border-radius:4px;background:#6c757d;display:flex;align-items:center;justify-content:center;color:white;font-size:10px;font-weight:bold;">R</div>
        <span class="label-text">RMO Panel</span>
      </a>
      @endif
