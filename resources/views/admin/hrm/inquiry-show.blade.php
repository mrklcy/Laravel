...
<div class="d-flex justify-content-between align-items-start mb-3">
  <div class="d-flex align-items-center gap-3">
    <a href="{{ route('admin.hrm.inquiries') }}" class="btn btn-outline-secondary rounded-4">
  ...
  <div class="col-lg-8">
    <div class="card rounded-4 border">
      <div class="card-body p-4">
        ...
        <form action="{{ route('admin.hrm.inquiries.update', $inquiry) }}" method="POST" class="mt-4">
          @csrf
          @method('PUT')
          ...
          <div class="d-flex gap-2">
            ...
            <a href="{{ route('admin.hrm.inquiries') }}" class="btn btn-outline-secondary rounded-4 px-4">Back to List</a>
          </div>
        </form>
      </div>
    </div>
