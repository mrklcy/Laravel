...
@section('title', 'HRMO Dashboard')
@section('crumb', 'HRMO')

@section('content')
<div class="mb-4">
  <h1 class="h3 fw-bold mb-1">Human Resource Management Office</h1>
  <p class="text-muted">Employee management and HR statistics</p>
</div>
...
<div class="card rounded-4 border">
  <div class="card-body p-4">
    ...
    <div class="row g-3">
      <div class="col-md-3">
        <a href="{{ route('admin.hrm.employees.create') }}" class="btn btn-outline-secondary w-100 rounded-3 py-3">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="mb-2">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
          </svg>
          <div class="small fw-bold">Add Employee</div>
        </a>
      </div>
      <div class="col-md-3">
        <a href="{{ route('admin.hrm.employees') }}" class="btn btn-outline-secondary w-100 rounded-3 py-3">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="mb-2">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
          </svg>
          <div class="small fw-bold">View All Users</div>
        </a>
      </div>
      <div class="col-md-3">
        <a href="{{ route('admin.hrm.reports') }}" class="btn btn-outline-secondary w-100 rounded-3 py-3">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="mb-2">
      ...
      <div class="col-md-3">
        <a href="{{ route('admin.hrm.analytics') }}" class="btn btn-outline-secondary w-100 rounded-3 py-3">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="mb-2">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
          </svg>
          <div class="small fw-bold">View Analytics</div>
        </a>
      </div>
    </div>
  </div>
