...
<div class="d-flex justify-content-between align-items-start mb-3">
  <div class="d-flex align-items-center gap-3">
    ...
    <div>
      <h1 class="h3 fw-bold mb-1">Create New Service</h1>
      <div class="text-muted">Add a new service to ADSO</div>
    </div>
  </div>
</div>
    ...
    <div class="card rounded-4 border bg-light">
      <div class="card-body">
        ...
        <ul class="small text-muted mb-0">
          <li class="mb-2">Use clear, descriptive titles for services</li>
          <li class="mb-2">Slugs should be lowercase with hyphens</li>
          <li class="mb-2">The description helps users understand the service</li>
          <li>Use display order to control how services appear in lists</li>
        </ul>
      </div>
    </div>
  </div>
